...
export default function VcmAdminSidebar({ sidebarOpen, toggleSidebar }) {
    ...
    <>
      ...
      >
        <div className="sidebar-header d-flex justify-content-between align-items-center">
          <h5 className="sidebar-title">VCM Admin Panel</h5>
        ...
        <nav className="sidebar-nav">
          <Nav className="flex-column">
            <Nav.Item>
              <Nav.Link as={Link} to="/vcm-admin-dashboard" className="nav-link" onClick={toggleSidebar}>
                <i className="bi bi-speedometer2 me-2"></i>
                Dashboard
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link as={Link} to="/vcm-admin-dashboard/view-company-admins" className="nav-link" onClick={toggleSidebar}>
